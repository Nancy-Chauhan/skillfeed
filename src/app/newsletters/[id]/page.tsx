  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#09090B]">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 pt-24 pb-10 space-y-8">
        {/* Back button */}
        <Link href="/dashboard">
          <Button variant="ghost" className="text-white/60 hover:text-white/80 hover:bg-white/[0.04] -ml-2 cursor-pointer text-[13px]">
        ...
        <div className="space-y-1">
          <p className="font-mono text-[10px] text-white/60 tracking-[0.15em] uppercase mb-4">
            Featured for you
          </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {article.source_name && (
                      <span className="text-[11px] text-white/60">{article.source_name}</span>
                    )}
                  </div>
                  {article.summary && (
