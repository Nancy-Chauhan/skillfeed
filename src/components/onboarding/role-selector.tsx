          ...
          {showInput ? (
            <div className="flex items-center gap-2">
              <input
                ...
                className="h-9 px-3 rounded-lg border border-white/[0.08] bg-white/[0.03] text-white text-sm placeholder:text-white/40 focus:border-violet-500/40 focus:ring-1 focus:ring-violet-500/20 outline-none flex-1"
              />
              <button
                type="button"
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[13px] text-white/55 hover:text-white/75 cursor-pointer transition-colors"
            >
