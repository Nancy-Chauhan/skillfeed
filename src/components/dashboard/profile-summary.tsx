      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-2.5">
            <p className="font-mono text-[11px] text-white/60 uppercase tracking-wider">current</p>
          ...
          <div className="space-y-2.5">
            <p className="font-mono text-[11px] text-white/60 uppercase tracking-wider">target</p>
            <div className="flex flex-wrap gap-1.5">
        ...
        {extractedSkills.length > 0 && (
          <div className="space-y-2.5">
            <p className="font-mono text-[11px] text-white/60 uppercase tracking-wider">skills</p>
            <div className="flex flex-wrap gap-1.5">
        ...
        {learningGoals.length > 0 && (
          <div className="space-y-2.5">
            <p className="font-mono text-[11px] text-white/60 uppercase tracking-wider">goals</p>
