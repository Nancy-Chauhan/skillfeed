...
const features = [
  {
    ...
    description:
      "Tell us your current role and your target role. We identify the skill gaps and match content that closes them.",
  ...
  },
  {
    ...
    description:
      "Every article comes with a personalized explanation: why it matters for YOUR specific career move, not generic fluff.",
  ...
  },
  {
    key: "sources",
    icon: Layers,
    title: "Every newsletter, zero noise",
    description:
      "We scan every major AI and tech newsletter daily. You get 3-5 articles. Zero duplicates, pure signal.",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div ref={headerRef} className="scroll-reveal text-center max-w-xl mx-auto mb-14 md:mb-16 space-y-4">
          ...
          <h2 className="text-3xl md:text-[2.75rem] font-bold text-white tracking-[-0.02em] leading-tight">
            ...
            <br />
            <span className="text-white/50">not just what&apos;s trending.</span>
          </h2>
          <p className="text-sm text-white/45 leading-relaxed max-w-md mx-auto font-mono">
            Tell us where you are and where you want to be. We handle the rest.
          </p>
        </div>
